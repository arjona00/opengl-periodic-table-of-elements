...
void ElementosQuimicosBD::loadBD() {
    ...
    ElementoQuimico hidrogeno = ElementoQuimico("Hidrogeno", "H", 1, 1, 1.00794, 1);
    ...
    ElementoQuimico nitrogeno = ElementoQuimico("Nitrogeno", "N", 7, 7, 14.00674, 7);
    addElemento(nitrogeno);
    cout << "Nitrógeno OK." << endl;
    
    cout << "8 - Oxígeno: " << endl;
    ElementoQuimico oxigeno = ElementoQuimico("Oxigeno", "O", 8, 8, 15.9994, 8);
    addElemento(oxigeno);
    cout << "Oxígeno OK." << endl;
    
    cout << "9 - Flúor: " << endl;
    ElementoQuimico fluor = ElementoQuimico("Fluor", "F", 9, 9, 18.9984032, 9);
    addElemento(fluor);
    cout << "Flúor OK." << endl;
    
    cout << "10 - Neón: " << endl;
    ElementoQuimico neon = ElementoQuimico("Neon", "Ne", 10, 10, 20.1797, 10);
    addElemento(neon);
    cout << "Neón OK." << endl;
    ...
    ElementoQuimico fosforo = ElementoQuimico("Fosforo", "P", 15, 15, 30.973761, 15);
    addElemento(fosforo);
    ...
    cout << "18 - Argón: " << endl;
    ElementoQuimico argon = ElementoQuimico("Argon", "A", 18, 18, 39.948, 18);
    addElemento(argon);
    cout << "Argón OK." << endl;
    ...
    cout << "28 - Níquel: " << endl;
    ElementoQuimico niquel = ElementoQuimico("Niquel", "Ni", 28, 28, 58.6934, 28);
    addElemento(niquel);
    cout << "Níquel OK." << endl;
